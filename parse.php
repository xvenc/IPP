...
* Main modul to parse code written in IPPcode22
*/

include 'src_parse/analyzer.php';
include 'src_parse/generate.php';
...
while(($line = fgets(STDIN)) !== FALSE) {
    ...
    // switch to identify the instruction, if it doesnt match any instruction exit with code 22
    switch($instruction) {
